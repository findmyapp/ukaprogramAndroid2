...
public class RestMethod 
{
	...
	private String executeGet(HttpRequestBase request) throws HTTPStatusException {
		...
		this.mClient = new DefaultHttpClient();
			...
			// TODO: Hvorfor må den signes når man ikke trenger å authes?
//			try {
...
//			}
			...
			try {
				...
				Log.e(debug, "ClientProtocolExc: " + e.getMessage());
				return ""; 
			} catch (IOException e) {
				Log.e(debug, "IOExc: " + e.getMessage());
				return ""; 
			}
