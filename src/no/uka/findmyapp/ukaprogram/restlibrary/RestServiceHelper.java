...
import no.uka.findmyapp.ukaprogram.restlibrary.RestServiceException.RestHelperException;
...
//		}
	...
	public void callStartService(Context context, ServiceModel serviceModel) {
		...
		if(hasUserToken()) {
			selectIntent.putExtra(IntentMessages.USER_TOKEN_PACKAGE, userToken);
		}
