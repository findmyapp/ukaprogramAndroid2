...
import no.uka.findmyapp.ukeprogram.models.Fact;
import no.uka.findmyapp.ukeprogram.models.HttpType;
import no.uka.findmyapp.ukeprogram.models.Humidity;
import no.uka.findmyapp.ukeprogram.models.LocationCount;
import no.uka.findmyapp.ukeprogram.models.Noise;
import no.uka.findmyapp.ukeprogram.models.ServiceModel;
import no.uka.findmyapp.ukeprogram.models.Temperature;
import no.uka.findmyapp.ukeprogram.models.UkaEvent;
import no.uka.findmyapp.ukeprogram.models.User;
		...
		try {
			switch (service) {
				...
				case GET_UKA_PROGRAM_FOR_DATE: 
					...
					if (Constants.DEBUG) Log.d("GET EVENTS FOR DATE2", model.toString());
