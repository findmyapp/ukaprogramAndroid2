...
public class UkaEventProvider extends ContentProvider {
	...
	public int delete(Uri uri, String where, String[] whereArgs) {
		if (Constants.DEBUG) Log.v(debug, "Inside delete");
	...
	public String getType(Uri uri) {
		if (Constants.DEBUG) Log.v(debug, "Inside getType");
		switch (uriMatcher.match(uri)) {
		case UKAEVENTS:
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
		if (Constants.DEBUG) Log.v(debug, "Inside insert");
	...
	public boolean onCreate() {
		if (Constants.DEBUG) Log.v(debug, "Inside onCreate");
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		if (Constants.DEBUG) Log.v(debug, "Inside query");
		...
		if (Constants.DEBUG) Log.v(debug, "query: querystatment " + qb.toString());
	...
	public int update(Uri uri, ContentValues values, String where,
			String[] whereArgs) {
		if (Constants.DEBUG) Log.v(debug, "Inside update");
		SQLiteDatabase db = dbHelper.getWritableDatabase();
		int count;
		String finalWhere;
	...
	private static class EventsDatabaseHelper extends SQLiteOpenHelper {
		...
		public EventsDatabaseHelper(Context context) {
			...
			if (Constants.DEBUG) Log.v(debug, "Inside constructor");
		}
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			if (Constants.DEBUG) Log.v(debug, "Inside onUpgrade");

			if (Constants.DEBUG) Log.w(debug, "Upgrading database, version:" + oldVersion + " to "
